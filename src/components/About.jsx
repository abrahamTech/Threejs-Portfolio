  ...
  return (
    <>
      ...
      <motion.p
        ...
        className='mt-4 text-secondary text-[1rem] max-w-3xl leading-[30px]'
      >
        I'm a skilled software developer with experience in Scala and JavaScript, and expertise in frameworks like React and Angular.
